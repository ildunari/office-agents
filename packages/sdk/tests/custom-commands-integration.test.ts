  ...
  describe("web-fetch", () => {
    ...
    it("fetches a text page and saves to file", async () => {
      vi.spyOn(globalThis, "fetch").mockResolvedValue(
        new Response("<html><head><title>Example Domain</title></head><body><main><h1>Example Domain</h1><p>This domain is for use in illustrative examples.</p></main></body></html>", {
          status: 200,
